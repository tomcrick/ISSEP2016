...
% : the McKinsey Report~\cite{McKinsey:1997}
...
% (originally the Department for Children,
...
% \footnote{For example, i ts contributions to the new
...
% only published in March 2014~\cite{wgictresponse:2014}. 
...
%\footnote{\url{http://www.educationscotland.gov.uk/learningandteaching/thecurriculum/}}
